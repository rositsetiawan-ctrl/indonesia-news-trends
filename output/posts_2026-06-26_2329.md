...
```text
Photorealistic editorial tech illustration for a news post, 1:1 square. Depict this exact news event: a vast futuristic data center: endless rows of server racks glowing blue, cinematic depth of field, cool high-tech atmosphere. Make the scene clearly readable and literal so it matches the news story. Style: sleek modern tech-magazine look, cinematic lighting, high contrast, blue/cyan palette with a subtle Indonesian red accent, soft depth of field. Composition: one bold central focal subject, clear negative space at the top for a headline overlay. No real recognizable faces, no real brand logos, no text or letters in the image, no watermarks. --ar 1:1
```
